...
It adds a new enchantment for the elytra, which lets you use the creative mode flying in survival.
...
### Balancing
To counteract the huge benefit of creative flying I want to implement some drawback.
